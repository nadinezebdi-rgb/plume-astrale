 ...
 * Countdown 48h retiré (fake urgency = red flag conversion). Remplacé par
 * code promo activable sans pression temporelle.
 */
const LaunchBanner = () => {
  ...
  const segment = (
    ...
    >
      ✦&nbsp;&nbsp;20 CRÉDITS OFFERTS À L&apos;INSCRIPTION&nbsp;·&nbsp;CODE&nbsp;
