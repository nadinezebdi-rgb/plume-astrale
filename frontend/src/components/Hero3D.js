  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Cloud 1 - Long streaky cloud top left */}
        <g className="cloud cloud-1" filter="url(#cloudBlur)">
          <ellipse cx="80" cy="80" rx="120" ry="35" fill="rgba(232, 199, 102, 0.35)" />
          <ellipse cx="150" cy="75" rx="100" ry="30" fill="rgba(232, 199, 102, 0.3)" />
          <ellipse cx="210" cy="85" rx="90" ry="32" fill="rgba(232, 199, 102, 0.25)" />
          <ellipse cx="40" cy="90" rx="80" ry="28" fill="rgba(232, 199, 102, 0.2)" />
        </g>

        {/* Cloud 2 - Top right violet cloud */}
        <g className="cloud cloud-2" filter="url(#cloudBlur)">
          <ellipse cx="950" cy="120" rx="130" ry="38" fill="rgba(167, 139, 250, 0.3)" />
          <ellipse cx="1020" cy="115" rx="110" ry="32" fill="rgba(167, 139, 250, 0.25)" />
          <ellipse cx="1080" cy="125" rx="100" ry="35" fill="rgba(167, 139, 250, 0.2)" />
          <ellipse cx="900" cy="135" rx="95" ry="30" fill="rgba(167, 139, 250, 0.15)" />
        </g>

        {/* Cloud 3 - Bottom golden cloud */}
        <g className="cloud cloud-3" filter="url(#cloudBlur)">
          <ellipse cx="350" cy="680" rx="125" ry="36" fill="rgba(232, 199, 102, 0.3)" />
          <ellipse cx="420" cy="675" rx="105" ry="31" fill="rgba(232, 199, 102, 0.25)" />
          <ellipse cx="480" cy="685" rx="95" ry="33" fill="rgba(232, 199, 102, 0.2)" />
          <ellipse cx="300" cy="695" rx="85" ry="28" fill="rgba(232, 199, 102, 0.15)" />
        </g>

        {/* Cloud 4 - Middle violet cloud */}
        <g className="cloud cloud-4" filter="url(#cloudBlur)">
          <ellipse cx="700" cy="480" rx="128" ry="37" fill="rgba(167, 139, 250, 0.28)" />
          <ellipse cx="770" cy="475" rx="108" ry="31" fill="rgba(167, 139, 250, 0.23)" />
          <ellipse cx="830" cy="485" rx="98" ry="34" fill="rgba(167, 139, 250, 0.18)" />
          <ellipse cx="650" cy="495" rx="90" ry="29" fill="rgba(167, 139, 250, 0.13)" />
        </g>

        {/* Scattered stars */}
        <circle cx="50" cy="80" r="1.2" className="star star-1" fill="rgba(227, 215, 255, 0.85)" />
        <circle cx="320" cy="120" r="1.0" className="star star-2" fill="rgba(227, 215, 255, 0.75)" />
        <circle cx="1100" cy="200" r="1.1" className="star star-3" fill="rgba(227, 215, 255, 0.85)" />
        <circle cx="200" cy="250" r="0.9" className="star star-4" fill="rgba(227, 215, 255, 0.7)" />
        <circle cx="1050" cy="450" r="1.0" className="star star-5" fill="rgba(227, 215, 255, 0.75)" />
        <circle cx="150" cy="600" r="1.1" className="star star-6" fill="rgba(227, 215, 255, 0.85)" />
        <circle cx="900" cy="300" r="0.9" className="star star-1" fill="rgba(227, 215, 255, 0.7)" />
        <circle cx="500" cy="450" r="1.0" className="star star-2" fill="rgba(227, 215, 255, 0.75)" />
        <circle cx="1150" cy="650" r="0.95" className="star star-3" fill="rgba(227, 215, 255, 0.8)" />
        <circle cx="80" cy="500" r="1.1" className="star star-4" fill="rgba(227, 215, 255, 0.85)" />
      </svg>
