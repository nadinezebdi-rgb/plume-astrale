...
const Numerologie = () => {
  ...
  // ── Couleurs par nombre ──────────────────────────────────────────────────────
  const numColor = (n) => {
    const colors = { 1:'#F87171',2:'#60A5FA',3:'#FBBF24',4:'#34D399',5:'#A78BFA',6:'#F472B6',7:'#38BDF8',8:'#FB923C',9:'#A3E635',11:'#E879F9',22:'#C5A059',33:'#FDE68A' };
    return colors[n] || '#C5A059';
  };
        ...
        <div className="relative z-10 px-6 md:px-8 py-20 md:py-28">
          <div className="max-w-xl mx-auto">
            ...
            <div className="rounded-2xl p-8 text-center" style={{ background: 'var(--pa-surface)', border: '1px solid var(--pa-divider)' }}>
              ...
              <p className="text-sm mb-7" style={{ color: '#C5A059' }}>10 crédits · 20 crédits offerts à l'inscription</p>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { icon: <Sparkles className="w-4 h-4" strokeWidth={1.5} />, title: 'Année Personnelle 2026', desc: "Ce cycle annuel révèle l'énergie dominante de votre année en cours et les thèmes à travailler.", color: '#C5A059' },
            ...
            <div className="animate-fade-in">
              ...
              <div className="flex gap-1 mb-8 p-1 rounded-xl" style={{ background: 'var(--pa-surface)' }}>
                {[
                  ...
                  <button key={tab.key} onClick={() => { setActiveTab(tab.key); if (tab.key === 'deep' && !deepResult) handleDeepProfile(); }}
                    ...
                    style={{
                      background: activeTab === tab.key ? '#C5A059' : 'transparent',
              ...
              {activeTab === 'base' && (
                <div className="space-y-5">
                  ...
                  {result.annee_personnelle_2026 && (
                    <div className="rounded-2xl p-5" style={{ background: 'rgba(197,160,89,0.05)', border: '1px solid rgba(197,160,89,0.18)' }}>
                      <div className="flex items-center gap-3 mb-3">
                        <span className="text-2xl font-light" style={{ color: '#C5A059', fontFamily: 'Cormorant Garamond, serif' }}>
                          {result.annee_personnelle_2026.nombre || result.annee_personnelle_2026}
                        </span>
                        <p className="text-xs tracking-widest uppercase" style={{ color: '#C5A059', letterSpacing: '0.12em' }}>Année Personnelle 2026</p>
                      </div>
                  ...
                  {deepResult && !loadingDeep && (
                    <>
                      ...
                      {deepResult.annee_personnelle_2026 && (
                        <div className="rounded-2xl p-5" style={{ background: 'rgba(197,160,89,0.05)', border: '1px solid rgba(197,160,89,0.18)' }}>
                          <div className="flex items-center gap-3 mb-3">
                            <span className="text-2xl font-light" style={{ color: '#C5A059', fontFamily: 'Cormorant Garamond, serif' }}>{deepResult.annee_personnelle_2026.nombre}</span>
                            <p className="text-xs tracking-widest uppercase" style={{ color: '#C5A059', letterSpacing: '0.12em' }}>Année Personnelle 2026</p>
                          </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-8 pt-6" style={{ borderTop: '1px solid var(--pa-divider)' }}>
                <button onClick={() => { setResult(null); setDeepResult(null); setShowForm(true); setUnlocked(false); setActiveTab('base'); }}
                  className="flex-1 py-3 rounded-xl text-xs uppercase tracking-widest hover:bg-[rgba(197,160,89,0.08)] transition-all"
