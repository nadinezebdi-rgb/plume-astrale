  ...
  if (!user?.birth_date) {
    return (
      <div className="min-h-screen px-6 py-20 flex items-center justify-center" data-testid="ll-no-natal">
        <div className="card-mystical text-center max-w-md">
          <p className="text-[#F0E6D3] mb-3">Vos données natales sont requises.</p>
          ...
          <div className="space-y-6 animate-fade-in" data-testid="ll-result">
            <div className="card-mystical text-center glow-gold">
              ...
              {(primary.description || primary.text) && (
                <p className="text-[#F0E6D3]/85 leading-relaxed max-w-lg mx-auto" style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '16px', lineHeight: '1.85' }}>
                  {primary.description || primary.text}
                </p>
              )}
            </div>
            ...
            {summary && (
              <div className="card-mystical">
                <p className="text-[#F0E6D3]/85 leading-relaxed" style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '16px', lineHeight: '1.9' }} data-testid="ll-summary">
                  {summary}
                </p>
              </div>
            )}
