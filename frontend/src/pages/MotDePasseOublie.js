      ...
      <div className="w-full max-w-md">
        <div className="rounded-2xl p-8 md:p-10" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(212,175,55,0.15)', backdropFilter: 'blur(16px)' }}>
          ...
          <div className="flex items-center justify-center gap-3 mb-3">
            <Mail className="w-5 h-5" style={{ color: '#D4AF37' }} strokeWidth={1.5} />
          ...
          {sent ? (
            <div className="text-center" data-testid="forgot-success">
              ...
              <Link to="/connexion" className="inline-block mt-6 text-xs uppercase tracking-widest px-6 py-2.5 rounded-full" style={{ border: '1px solid rgba(212,175,55,0.5)', color: '#D4AF37' }}>
                Retour
              </Link>
            </div>
          ) : (
