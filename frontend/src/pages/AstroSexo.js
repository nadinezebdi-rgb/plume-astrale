    ...
    <div className="min-h-screen pt-24 pb-20 px-4" data-testid="astrosexo-page">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-14">
          <p className="text-[10px] uppercase tracking-[0.3em] mb-3" style={{ color: '#D4B46A', fontFamily: 'Cinzel, serif' }}>
          ...
          <h1 className="text-4xl sm:text-5xl mb-5" style={{ fontFamily: 'Cormorant Garamond, serif', color: '#F0E6D3', fontWeight: 300, lineHeight: 1.05 }}>
            <em style={{ fontStyle: 'italic', color: '#D4B46A' }}>AstroSexo</em>
          </h1>
          ...
          <p className="text-xs italic max-w-lg mx-auto" style={{ color: 'rgba(212,180,106,0.75)', lineHeight: 1.65 }}>
          ...
          {SIGN_LIST.map((s) => {
            ...
            return (
              <button
                ...
                style={{
                  background: isActive ? 'rgba(212,180,106,0.14)' : 'rgba(255,255,255,0.025)',
                  border: `1px solid ${isActive ? '#D4B46A' : 'rgba(212,180,106,0.15)'}`,
        ...
        {selected && (
          <section id="astrosexo-reveal" className="rounded-2xl p-6 sm:p-8 mb-10" style={{
            ...
            <div className="flex items-baseline justify-between mb-4 pb-4" style={{ borderBottom: '1px solid rgba(212,180,106,0.2)' }}>
              <div>
                <p className="text-[10px] uppercase tracking-widest" style={{ color: '#D4B46A', letterSpacing: '0.14em', fontFamily: 'Cinzel, serif' }}>Le profil sensuel du</p>
                <h2 className="text-3xl mt-1" style={{ fontFamily: 'Cormorant Garamond, serif', color: '#F0E6D3', fontWeight: 300 }}>
                  <em style={{ color: '#D4B46A' }}>{selected.sign}</em>
                </h2>
              </div>
            ...
            <p className="text-[10px] uppercase tracking-widest mb-4" style={{ color: '#D4B46A', letterSpacing: '0.14em', fontFamily: 'Cinzel, serif' }}>Vos 3 signes les plus compatibles</p>
            <div className="grid sm:grid-cols-3 gap-3 mb-6">
              {selected.ideal.map((match, i) => (
                <div key={i} className="rounded-xl p-4" style={{
                  ...
                  <h3 className="text-base mb-2" style={{ fontFamily: 'Cormorant Garamond, serif', color: '#F4D98C' }}>
                    ✦ {match.sign}
                  </h3>
        ...
        <section className="rounded-2xl p-8 sm:p-10 text-center" style={{
          ...
          <Sparkles className="w-8 h-8 mx-auto mb-4" strokeWidth={1.3} style={{ color: '#D4B46A' }} />
          ...
          <Link
            ...
            style={{
              ...
              boxShadow: '0 6px 24px rgba(212,180,106,0.3)',
            }}
