      ...
      <div className="relative max-w-6xl mx-auto px-4 md:px-8 py-16 md:py-24" style={{ zIndex: 2 }}>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-24" data-testid="solena-hero-section">
          <div className="order-2 md:order-1">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-6"
              ...
              <Sparkles className="w-3 h-3" style={{ color: '#C5A059' }} strokeWidth={1.5} />
            ...
            <h1 className="text-5xl md:text-7xl mb-4" style={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 300, lineHeight: 1 }}>
              Je suis <em style={{ color: '#C5A059', fontStyle: 'italic' }}>{SOLENA.name}</em>.
            </h1>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link to="/consultation"
                ...
                style={{ border: '1px solid rgba(197,160,89,0.4)', color: '#C5A059', letterSpacing: '0.2em' }}
          ...
          <div className="order-1 md:order-2 flex justify-center">
            <div className="relative">
              <div style={{
                ...
                background: 'radial-gradient(circle, rgba(197,160,89,0.30), transparent 70%)',
                filter: 'blur(30px)',
              }} />
              <img src={SOLENA.portrait} alt="Portrait de Solena — astrologue"
                ...
                style={{
                  ...
                  boxShadow: '0 40px 100px rgba(197,160,89,0.30), 0 0 60px rgba(197,160,89,0.20)',
                }}
        ...
        <div className="max-w-3xl mx-auto mb-24" data-testid="solena-bio-section">
          <div className="text-center mb-10">
            <div className="text-[10px] uppercase mb-3" style={{ color: '#C5A059', letterSpacing: '0.3em' }}>
              Ma mission
            </div>
            <h2 className="text-4xl md:text-5xl" style={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 300 }}>
              Une <em style={{ color: '#C5A059', fontStyle: 'italic' }}>conversation intime</em>
        ...
        <div className="mb-24" data-testid="solena-specialities">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl" style={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 300 }}>
              Six voies pour <em style={{ color: '#C5A059', fontStyle: 'italic' }}>t&apos;éclairer</em>
            </h2>
          </div>
            ...
            {SOLENA.specialities.map((s, i) => (
              <div key={i}
                ...
                <div className="flex-shrink-0 mt-0.5">
                  <CheckCircle2 className="w-5 h-5" style={{ color: '#C5A059' }} strokeWidth={1.5} />
                </div>
        ...
        <div className="rounded-3xl p-8 md:p-12 max-w-4xl mx-auto text-center relative overflow-hidden"
          style={{
            ...
            boxShadow: '0 40px 120px rgba(197,160,89,0.25)',
          ...
          <div className="relative">
            <Moon className="w-10 h-10 mx-auto mb-4" style={{ color: '#C5A059' }} strokeWidth={1.2} />
            <h2 className="text-3xl md:text-4xl mb-4" style={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 300 }}>
              Prête à découvrir ce que <em style={{ color: '#C5A059', fontStyle: 'italic' }}>tes étoiles</em> murmurent ?
            </h2>
