...
const NumerologieWaiting = () => {
  ...
  useEffect(() => {
    ...
    const pollStatus = async () => {
      try {
        const response = await fetch(`${API_URL}/api/numerologie/status?session_id=${sessionId}`);
        ...
        {status === 'loading' || status === 'waiting' ? (
          <>
            ...
            <p className="text-[#E3D7FF] mb-4 text-lg">
              Nous créons ton rapport numérologique personnalisé...
            </p>
          ...
          <>
            ...
            <p className="text-[#E3D7FF] mb-8 text-lg">
              Ton Code Numérologique a été généré avec succès.
            </p>
            ...
            <button
              onClick={() => navigate('/numerologie-pdf')}
...
export default NumerologieWaiting;
