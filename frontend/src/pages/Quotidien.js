    ...
    <div className="min-h-screen relative">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-12 flex items-start gap-6">
          <img src="https://customer-assets.emergentagent.com/job_6ebe2661-1b82-4742-afc5-632bf29dfcc5/artifacts/vg88c54m_IMG4.png" alt="" className="w-20 md:w-28 flex-shrink-0 rounded-full opacity-80" style={{ filter: 'drop-shadow(0 0 20px rgba(212,175,55,0.15))' }} />
          <div>
            ...
            <div data-testid="horoscope-detail">
              ...
              <div className="space-y-8">
                {[
                  ...
                  { key: 'carriere', label: 'Carriere', color: '#D4AF37' },
