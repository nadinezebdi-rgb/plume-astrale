        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              style={{
                background: 'linear-gradient(135deg, #C5A059, #D4B46A)',
                color: '#0B0B0F',
                fontWeight: 600,
                letterSpacing: '0.1em',
                border: 'none',
              }}
              onMouseEnter={e => { e.currentTarget.style.boxShadow = '0 0 24px rgba(197,160,89,0.5)'; e.currentTarget.style.transform = 'translateY(-2px)'; }}
              ...
              return (
                <div key={i} className="flex items-start gap-5 card-editorial p-6" data-testid={`premium-step-preview-${i}`}>
                  <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center"
                    style={{ border: '1px solid var(--pa-divider)', background: 'rgba(197,160,89,0.05)' }}>
        ...
        <div className="max-w-lg mx-auto text-center">
          <div className="card-editorial p-8 md:p-10">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-6 text-[11px] uppercase tracking-widest"
              style={{ background: 'rgba(197,160,89,0.12)', border: '1px solid rgba(197,160,89,0.3)', color: '#C5A059', letterSpacing: '0.12em' }}>
              ✨ Abonnement mensuel
            </div>
            ...
            <div className="mb-6">
              ...
              <span className="text-2xl" style={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 300, color: '#C5A059' }}>,99</span>
            ...
            <div className="mt-6 pt-6" style={{ borderTop: '1px solid var(--pa-divider)' }}>
              {!showPromo ? (
                <button onClick={() => setShowPromo(true)} className="text-xs transition-colors duration-300 hover:text-[#C5A059]"
