        ...
        <div className="relative z-10 px-6 md:px-8 py-20 md:py-28">
          <div className="max-w-xl mx-auto">
            ...
            <div className="rounded-2xl p-8 text-center" style={{ background: 'var(--pa-surface)', border: '1px solid var(--pa-divider)' }}>
              ...
              <p className="text-sm mb-7" style={{ color: '#D4AF37' }}>15 crédits · 20 crédits offerts à l'inscription</p>
            ...
            <div className="space-y-8 mb-10 animate-fade-in">
              ...
              <div className="space-y-3">
                {[
                  ...
                  { icon: '✦', title: 'Mission de Vie', desc: 'Votre raison d\'être profonde dans cette vie. Ce que l\'univers attend de vous spécifiquement.', color: '#D4AF37' },
              ...
              <div className="text-center pt-4">
                <p className="text-sm mb-5" style={{ color: 'var(--pa-muted)' }}>
                  <Coins className="w-4 h-4 inline mr-1" style={{ color: '#D4AF37' }} strokeWidth={1.5} />
                  <span style={{ color: '#D4AF37' }}>15 crédits</span> · Solde actuel : {creditBalance} crédits
                </p>
                <button
          ...
          {result && (result.data?.karma_principal || result.data?.mission_de_vie || result.data?.noeuds_lunaires) && (
            <div className="space-y-6 animate-fade-in">
              ...
              {result.data?.mission_de_vie && (
                <div className="rounded-2xl p-6 md:p-8" style={{ background: 'var(--pa-surface)', border: '1px solid rgba(212,175,55,0.25)' }}>
                  <p className="text-xs tracking-widest uppercase mb-2" style={{ color: '#D4AF37', letterSpacing: '0.12em' }}>✦ Mission de Vie</p>
                  <h2 className="text-xl mb-4" style={{ fontFamily: 'Cormorant Garamond, serif', color: 'var(--pa-heading)', fontWeight: 400 }}>
              ...
              {result.data?.noeuds_lunaires && (
                <div className="rounded-2xl p-6 md:p-8" style={{ background: 'var(--pa-surface)', border: '1px solid rgba(107,181,232,0.25)' }}>
                  ...
                  <p className="text-sm mb-1" style={{ color: '#D4AF37', fontWeight: 500 }}>
              ...
              {result.data?.message_akashique && (
                <div className="rounded-2xl p-6 md:p-8" style={{ background: 'rgba(212,175,55,0.04)', border: '1px solid rgba(212,175,55,0.15)' }}>
                  <div className="flex items-center gap-3 mb-4">
                    <span className="w-12 h-12 rounded-full flex items-center justify-center text-xl font-light flex-shrink-0"
                      style={{ background: 'rgba(212,175,55,0.12)', border: '1px solid rgba(212,175,55,0.3)', color: '#D4AF37', fontFamily: 'Cormorant Garamond, serif' }}>
                      {result.data.nombre_karmique}
                    </span>
                    <p className="text-xs tracking-widest uppercase" style={{ color: '#D4AF37', letterSpacing: '0.12em' }}>Message des Archives Akashiques</p>
                  </div>
              ...
              {result.natal_chart && (
                <div className="rounded-2xl p-6 md:p-8 w-full" style={{ background: 'var(--pa-surface)', border: '1px solid rgba(212,175,55,0.2)' }}>
                  <p className="text-xs tracking-widest uppercase mb-4" style={{ color: '#D4AF37', letterSpacing: '0.12em' }}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    {result.natal_chart.soleil && (
                      <div className="p-3 rounded-xl" style={{ background: 'rgba(212,175,55,0.06)', border: '1px solid rgba(212,175,55,0.15)' }}>
                        <p className="text-xs uppercase tracking-widest mb-1" style={{ color: '#D4AF37' }}>☉ Soleil</p>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                      {result.natal_chart.planetes.slice(0, 9).map((p, i) => (
                        <div key={i} className="flex items-center gap-2 text-xs" style={{ color: 'var(--pa-body)' }}>
                          <span style={{ color: '#D4AF37' }}>{p.nom}</span>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-4">
                <button onClick={() => { setResult(null); setShowForm(true); setUnlocked(false); }}
                  className="flex-1 py-3 rounded-xl text-xs uppercase tracking-widest transition-all hover:bg-[rgba(212,175,55,0.08)]"
