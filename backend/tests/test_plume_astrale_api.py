...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://tarot-birth-chart.preview.emergentagent.com')
    ...
    def test_free_access_with_astro100(self):
        ...
        response = requests.post(
            ...
            json={
                ...
                "origin_url": "https://tarot-birth-chart.preview.emergentagent.com",
